...
class Home_CG_Premiere_Citoyennete extends StatefulWidget {
  const Home_CG_Premiere_Citoyennete({super.key});

  @override
  State<Home_CG_Premiere_Citoyennete> createState() =>
      _Home_CG_Premiere_CitoyenneteState();
}

class _Home_CG_Premiere_CitoyenneteState
    extends State<Home_CG_Premiere_Citoyennete> {
