...
class Home_CG_Premiere_Francais extends StatefulWidget {
  const Home_CG_Premiere_Francais({super.key});

  @override
  State<Home_CG_Premiere_Francais> createState() =>
      _Home_CG_Premiere_FrancaisState();
}

class _Home_CG_Premiere_FrancaisState extends State<Home_CG_Premiere_Francais> {
