...
class Home_CG_Premiere_Allemand extends StatefulWidget {
  const Home_CG_Premiere_Allemand({super.key});

  @override
  State<Home_CG_Premiere_Allemand> createState() =>
      _Home_CG_Premiere_AllemandState();
}

class _Home_CG_Premiere_AllemandState extends State<Home_CG_Premiere_Allemand> {
                      ...
                      Navigator.push(
                        ...
                        PageRouteBuilder(
                          pageBuilder: (context, animation,
                              ...
                              PdfViewPage(
                                  pdfFileName:
                                      "assets/epreuves/excellence/concours_general/premiere/allemand/cgs1_allemand_$date.pdf"),
                          transitionsBuilder:
