...
class Home_CG_Premiere_Espagnol extends StatefulWidget {
  const Home_CG_Premiere_Espagnol({super.key});

  @override
  State<Home_CG_Premiere_Espagnol> createState() =>
      _Home_CG_Premiere_EspagnolState();
}

class _Home_CG_Premiere_EspagnolState extends State<Home_CG_Premiere_Espagnol> {
