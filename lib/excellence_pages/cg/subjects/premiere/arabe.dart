...
class Home_CG_Premiere_Arabe extends StatefulWidget {
  const Home_CG_Premiere_Arabe({super.key});

  @override
  State<Home_CG_Premiere_Arabe> createState() => _Home_CG_Premiere_ArabeState();
}

class _Home_CG_Premiere_ArabeState extends State<Home_CG_Premiere_Arabe> {
