...
class Home_CG_Premiere_Italien extends StatefulWidget {
  const Home_CG_Premiere_Italien({super.key});

  @override
  State<Home_CG_Premiere_Italien> createState() =>
      _Home_CG_Premiere_ItalienState();
}

class _Home_CG_Premiere_ItalienState extends State<Home_CG_Premiere_Italien> {
