...
class Home_JP_Premiere_Physique extends StatefulWidget {
  const Home_JP_Premiere_Physique({super.key});

  @override
  State<Home_JP_Premiere_Physique> createState() =>
      _Home_JP_Premiere_PhysiqueState();
}

class _Home_JP_Premiere_PhysiqueState extends State<Home_JP_Premiere_Physique> {
                      ...
                      Navigator.push(
                        ...
                        PageRouteBuilder(
                          pageBuilder: (context, animation,
                              ...
                              PdfViewPage(
                                  pdfFileName:
                                      "assets/epreuves/excellence/junior_polytech/premiere/physique/JP_Physique_Pre_$date.pdf"),
                          transitionsBuilder:
