...
class Home_JP_Premiere extends StatefulWidget {
  const Home_JP_Premiere({super.key});

  @override
  State<Home_JP_Premiere> createState() => _Home_JP_PremiereState();
}

class _Home_JP_PremiereState extends State<Home_JP_Premiere> {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => SubjectsViewer(
                          ...
                          pdfFileName:
                              "assets/epreuves/excellence/junior_polytech/$level/$abbreviation/JP_${fileName[abbreviation]}_Pre",
                          level: level,
                          classe: classe,
                        ),
                      ),
